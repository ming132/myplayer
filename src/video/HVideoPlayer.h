...
public:
    HVideoPlayer() {
        ...
        set_aframe_cache(g_confile->Get<int>("frame_cache", "audio", DEFAULT_FRAME_CACHE));
    ...
    FrameStats get_aframe_stats() {
        return aframe_buf.frame_stats;
    }
    ...
    FrameInfo get_aframe_info() {
        return aframe_buf.frame_info;
    }
    ...
    void set_aframe_cache(int cache) {
        aframe_buf.setCache(cache);
    }
    ...
    int push_frame(HAFrame* pFrame) {
        return aframe_buf.push(pFrame);
    }
    ...
    int pop_frame(HAFrame* pFrame) {
        return aframe_buf.pop(pFrame);
    }
